...
Before starting any task, always read and consider the following documentation files:
- `docs/database-schema.md` - Database schema reference
- `docs/user-history.md` - User history and requirements
- `docs/project-phases.md` - Project phases and planning
- `docs/design/DESIGN.md` - **CRITICAL:** Always consult this design system documentation before creating or modifying any frontend solutions to ensure the UI strictly follows the "Digital Kineticist" design language (fonts, colors, depth, no-line rules).
